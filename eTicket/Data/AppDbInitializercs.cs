    ...
    public class AppDbInitializercs
    {
        public static void seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                //Cinema (if there are not any cinema in the database , you need to add some cinemas)
                ...
                var actor1 = context.Actor.FirstOrDefault(a => a.Id == 1);
                var actor2 = context.Actor.FirstOrDefault(a => a.Id == 2);
                var actor3 = context.Actor.FirstOrDefault(a => a.Id == 3);
                var actor4 = context.Actor.FirstOrDefault(a => a.Id == 4);
                var actor5 = context.Actor.FirstOrDefault(a => a.Id == 5);

                var movie1 = context.Movies.FirstOrDefault(m => m.Id == 1);
                var movie2 = context.Movies.FirstOrDefault(m => m.Id == 2);
                var movie3 = context.Movies.FirstOrDefault(m => m.Id == 3);
                var movie4 = context.Movies.FirstOrDefault(m => m.Id == 4);
                var movie5 = context.Movies.FirstOrDefault(m => m.Id == 5);
                var movie6 = context.Movies.FirstOrDefault(m => m.Id == 6);

                if (actor1 != null && actor2 != null && actor3 != null && actor4 != null && actor5 != null &&
                movie1 != null && movie2 != null && movie3 != null && movie4 != null && movie5 != null && movie6 != null)
                {
                    // Now, insert data with valid Actor and Movie references
